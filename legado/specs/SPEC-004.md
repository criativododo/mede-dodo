...
=======
[1]: `docs/finders/evidencias/FireShot-021-metricaDODO-localhost.pdf` — captura visual do estado atual, analisada em tiles verticais.
...
=======
[5]: `specs/SPEC-003.md` — arquitetura de informação e hierarquia em três níveis.

[6]: `docs/finders/FINDER-001.md` — componentes shadcn/ui e receitas de adaptação para MVP.

[7]: `docs/finders/FINDER-003.md` — benchmarks Modash e referências externas de dashboards.

[8]: `docs/issues/ISSUE-0001.md` — regras semânticas, procedência, brand suitability e custo zero.
>>>>>>> worktree-mede-dodo-sprint003
